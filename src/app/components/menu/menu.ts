...
export class Menu {
  ...
  externalLinks = [
    { iconCDN: "/icons/icons8-linkedin-96.png", title: "Linkedin"},
    { iconCDN: "/icons/icons8-github-logo-96.png", title: "GitHub"},
    { iconCDN: "/icons/icons8-gmail-96.png", title: "Contacto"}
  ]
}
