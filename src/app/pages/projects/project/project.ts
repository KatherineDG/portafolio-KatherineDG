...
export class Project {
    ...
    projects = [
    { name: 'EduConnectAI',
      imageFolder: 'educonnectai',
      totalImages: 15,
      media: ['png','png','png','png','png','png','png','png','png','png','png','png','png','png','png'],
    ...
    { name: 'BeluAr Gateway de Pagos',
      imageFolder: 'gatewaydepagos',
      totalImages: 6,
      media: ['png','png','png','png','mp4','mp4'],
    ...
    { name: 'Kukit',
      imageFolder: 'kukit',
      totalImages: 8,
      media: ['png','png','png','png','png','png','png','png'],
    ...
    { name: 'EcoSense',
      imageFolder: 'ecosense',
      totalImages: 3,
      media: ['png','png','png','png'],
  ...
  nextImage() {
    ...
    this.currentImage =
      (this.currentImage + 1) % project.totalImages;
  }
